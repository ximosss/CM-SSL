...
from baselines.SimSiam.simsiam_pretraining import SimSiam_TS
...
def main(cfg: DictConfig):
    ...
    siam_model.load_state_dict(pretrained_dict)

    if rank == 0:
        print("SimSiam weights loaded successfully.")

    backbone = siam_model.encoder
    feature_dim = backbone.dense[0].in_features 
